---
title: "Savings Rate Documentation"
description: "API response documentation for the latest available interest rate for high-yield savings accounts, including structure, fields, and example output."
icon: "savings"
---
