---
title: "Mortgage Rate Documentation"
description: "API response documentation for the latest available mortgage interest rate, including structure, fields, and example output."
icon: "percent"
---
